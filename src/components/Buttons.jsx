...
export default function Buttons() {
  ...
  function loseFocus(e) {
    // Lose focus on the clicked element to shift focus away from the button element to prevent a false entry when the enter keyboard button is clicked after just entering an element by clicking on the button using the interface
  ...
  const numberBtn =
    mode === "light"
      ? "bg-white/30 text-[#339DFF] active:bg-white/50"
      : "bg-white/30 text-white active:bg-white/50";
  ...
  return (
    <div className="w-full">
      <div className="buttonContainer mx-auto w-fit py-10 px-5 grid grid-cols-[45px_45px_45px_45px] grid-rows-[45px_45px_45px_45px_45px] sm:grid-cols-[45px_45px_45px_45px_45px] sm:grid-rows-[45px_45px_45px_45px] gap-5 sm:gap-4 justify-center content-center">
        ...
        <button
          className={`poppins-black ${metaBtn} bg-white/80 button  p-3 sm:col-span-2`}
          onClick={(e) => {
        ...
        {/* The equals button */}
        <button
          className={`row-span-2 sm:col-start-4 text-white sm:col-span-2 sm:row-start-4 sm:row-span-1 ${
            mode === "light" ? "bg-[#19ACFF]" : "bg-[#1991FF]"
          }`}
          onClick={equate}
        >
